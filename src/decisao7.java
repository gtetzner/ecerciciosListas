...
public class decisao7 {
    public static void main(String[] args) {
        ...
        if (numb1 < numb2 && numb1<numb3){
            System.out.println("o menor numero digitado foi " + numb1);
        }
        else if (numb2 < numb1 && numb2 < numb3 ){
            System.out.println("o menor numero digitado foi " + numb2);
        }

        else if (numb3 < numb2 && numb3 < numb1) {
            System.out.println(" o menor numero digitado foi " + numb3);
        }
        else if (numb3 == numb2 && numb3 == numb1) {
